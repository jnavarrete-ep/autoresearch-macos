#!/usr/bin/env python3
"""
Evaluation harness for autoskill-log-analyzer.
        ...
        benchmarks.append(
            {
                "name": path.stem,
                "content": content,
                "input_code": extract_section(content, "Input Logs"),
...
Now apply this skill to the following error logs:

{code}

Provide your analysis following the skill's output format."""
...
def judge_output(output: str, expected: str, scoring: str) -> float:
    ...
    prompt = f"""You are a strict evaluator. Score the following log analysis.
