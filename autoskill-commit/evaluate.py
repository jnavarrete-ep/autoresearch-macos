#!/usr/bin/env python3
"""
Evaluation harness for autoskill-commit.
Runs commit-writer skill against benchmarks and computes pass rate.
"""
...
Now apply this skill to the following git diff:
...
def judge_output(output: str, expected: str, scoring: str) -> float:
    prompt = f"""You are a strict evaluator for git commit messages.
...
Evaluate the commit message against EACH expected behavior. Be strict but fair.
